...
struct
  let () = I.internal "dcpr_inflate" (ptr char @-> int @-> ptr char @-> int @-> int @-> int @-> ptr void @-> returning int) inflate
  let () = I.internal "dcpr_deflate" (ptr char @-> int @-> ptr char @-> int @-> int @-> int @-> ptr void @-> returning int) deflate
end
